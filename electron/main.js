...
function startServer() {
  try {
    ...
    // On Linux use the bundled node binary (no .exe extension)
    const nodeBin = path.join(unpackedPath, 'server', 'car-rental-logger');
    ...
    serverProcess.unref();
    console.log('[server] car-rental-logger started, PID:', serverProcess.pid);
